 ...
 *
 * Asynchronously processes a backlog of strings at a given rate. The strings
 * are processed in a first in last out order.
 */
class Buffer {
public:
  /**
...
private:
  ...
  /**
   * @brief The function that will be applied to each string in the buffer when
   * it is removed.
   *
   */
