 ...
 *
 * LemLib uses a buffered wrapper around stdout in order to guarantee that
 * messages are printed at a constant rate, no matter how many different threads
 * are trying to use the logger. This is a concern  because not every type of
