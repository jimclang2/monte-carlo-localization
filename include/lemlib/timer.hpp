...
public:
   ...
   * @note the timer constructor is non-blocking so code after it will be
   * executed immediately
   * @note if the timer is constructed in a global scope, its behavior is
   * undefined. You can call set() before using the timer if you absolutely need
   * to construct it in a global scope
   *
